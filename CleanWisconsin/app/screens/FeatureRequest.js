...
export default class App extends React.Component {
    constructor() {
      super()
      this.state = {featureRequest: "Enter feature request here"}
    }
    render() {
        return (
          <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
              <View style={styles.layout}>
                ...
                <Image
                  source={require("../assets/images/image_OVrL.png")}
                  resizeMode="center"
                  style={styles.cleanWiscoLogo}
                >
                </Image>
                <ImageBackground
                  source={require("../assets/images/image_DvHN.png")}
                  resizeMode="cover"
    ...
    handleEmail = () => {
        ...
        email(to, {
            ...
            body: this.state.featureRequest
        }).catch(console.error)
    }
}
